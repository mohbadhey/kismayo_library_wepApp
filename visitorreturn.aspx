<%@ Page Title="" Language="C#" MasterPageFile="~/homePage.Master" AutoEventWireup="true" CodeBehind="visitorreturn.aspx.cs" Inherits="library.visitorreturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container-fluid text-white ">
                ...
                <div class="col-4 flex-row">
                    <input id="txtSearch" placeholder="Search visitor or book" onkeydown="Search_id()" type="text" class="form-control form-control-sm border" />
...
<div class="modal" id="myModal">
    ...
    <script>
      ...
      var exdate = document.getElementById("exdate").innerHTML;
            ...
            $.ajax({
                url: 'visitorreturn.aspx/submitissue',
  ...
  DataBind();
        function DataBind() {
            $.ajax({
                url: 'visitorreturn.aspx/DataBind2',
                dataType: "json",
                type: 'POST',
                contentType: "application/json",
                success: function (response) {
                    ...
                    for (var i = 0; i < response.d.length; i++) {
                        ...
                        $("#datatablee tbody").append(
                            ...
                            "<td>" + response.d[i].visitorname + "</td>" +
...
function Search_id() {
    ...
    $.ajax({
        url: 'visitorreturn.aspx/Search_id',
        data: "{'search':'" + search + "'}",
        dataType: "json",
        type: 'POST',
        contentType: "application/json",
