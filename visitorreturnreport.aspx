<%@ Page Title="" Language="C#" MasterPageFile="~/homePage.Master" AutoEventWireup="true" CodeBehind="visitorreturnreport.aspx.cs" Inherits="library.visitorreturnreport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container-fluid text-white ">
                ...
                <div class="col-3 flex-row">
                    <input id="txtSearch" placeholder="search visitor or books ...." onkeydown="Search_id()" type="text" class="form-control form-control-sm border" />
...
<div class="modal" id="myModal">
    ...
    <script>
        ...
        function bookreturn() {
            ...
            $.ajax({
                url: 'visitorreturnreport.aspx/submitissue',
  ...
  DataBind();
        function DataBind() {
            $.ajax({
                url: 'visitorreturnreport.aspx/DataBind2',
                dataType: "json",
                type: 'POST',
                contentType: "application/json",
                success: function (response) {
...
console.log("clicked");
  ...
  var rdate = cell[4].innerHTML;
         ...
         $.ajax({
             url: 'visitorreturn.aspx/stddetails',
             ...
             success: function (response) {
                 ...
                 for (var i = 0; i < students.length; i++) {
                     ...
                     $("#sname").text(student.visitorname);
...
function Search_id() {
    ...
    $.ajax({
        url: 'visitorreturnreport.aspx/Search_id',
        data: "{'search':'" + search + "'}",
        dataType: "json",
        type: 'POST',
        contentType: "application/json",
