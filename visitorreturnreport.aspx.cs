...
namespace library
{
    public partial class visitorreturnreport : System.Web.UI.Page
    {
        ...
        public static bkrtn[] DataBind2()
        {
            ...
            WHERE
                ...
                while (dr.Read())
                {
                    ...
                    field.stdname = dr["studentname"].ToString();
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                WHERE
                    ...
                    AND (
                        ...
                        OR s.[firstname] + ' ' + s.[middlename] + ' ' + s.[lastname] LIKE '%' + @search + '%'
                    );
            ", con);
                ...
                while (dr.Read())
                {
                    ...
                    field.bookname = dr["book_name"].ToString();
                    field.issue_date = dr["issuedate"].ToString();
                    field.extra_days = dr["extra_days"].ToString();
                    field.returndate = dr["returndate"].ToString();
                    field.days = dr["days"].ToString();
