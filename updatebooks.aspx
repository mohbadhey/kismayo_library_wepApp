<%@ Page Title="" Language="C#" MasterPageFile="~/homePage.Master" AutoEventWireup="true" CodeBehind="updatebooks.aspx.cs" Inherits="library.updatebooks" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
          <style>
        /* Custom CSS to change the color of pagination text */
        .dataTables_info {
        ...
        <div class="container-fluid text-white ">
            ...
            <div class="row p-4">
                ...
                <div class="col-4 flex-row">
                    <input id="txtSearch" placeholder="Search Books" onkeydown="Search_id()" type="text" class="form-control form-control-sm border" />
