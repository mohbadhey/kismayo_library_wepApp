<%@ Page Title="" Language="C#" MasterPageFile="~/homePage.Master" AutoEventWireup="true" CodeBehind="book_issue.aspx.cs" Inherits="library.book_issue" %>
...
<div class="modal" id="myModal">
    ...
    <span   id="rqty"></span>
           ...
           <div class="row">
               <div class="col-3">
                   <label class="form-label">Students Id</label>
...
$.ajax({
    url: 'book_issue.aspx/CheckIdExists',
    data: "{ 'std_id':'" + std_id + "' } ",
    ...
    success: function (rentResponse) {
        ...
        if (rentResponse.d === false) {
            ...
            $.ajax({
                url: 'book_issue.aspx/checkrentexist',
                data: "{ 'std_id':'" + std_id + "' } ",
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                type: 'POST',
                success: function (idExistsResponse) {
                    ...
                    if (idExistsResponse.d === true) {
                        ...
                        $.ajax({
                            url: 'book_issue.aspx/submitissue',
