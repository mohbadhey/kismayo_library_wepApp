<%@ Page Title="" Language="C#" MasterPageFile="~/website.Master" AutoEventWireup="true" CodeBehind="stdvisithistory.aspx.cs" Inherits="library.stdvisithistory" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "stdvisithistory.aspx/getfacul2",
                    data: "{'id':'" + id + "'} ",
        ...
        $(document).ready(function () {
            ...
            $('#dept1').change(function () {
                ...
                $.ajax({
                    url: 'stdvisithistory.aspx/GetRowCount',
