<%@ Page Title="" Language="C#" MasterPageFile="~/homePage.Master" AutoEventWireup="true" CodeBehind="visithistory.aspx.cs" Inherits="library.visithistory" %>
...
<i class="fa-solid fa-magnifying-glass"></i>Search
                ...
                <div class="col-3">
                              <input id="classs" type="text" placeholder="search classes...."  class="form-control"/>
                </div>
  
             <div class="col-2">
                  <select id="drpfacult21" class="form-control">
     ...
     <option>semester eight</option>
               ...
               <div class="col-2">
                       <button type="button" class="btn btn-primary pull-right" onclick="Search_DataBind()">
<i class="fa-solid fa-magnifying-glass"></i>Search
</button>
  ...
  <th scope="col">Visitation timesmes</th>
    ...
    <script type="text/javascript" src="//cdn.datatables.net/1.13.7/js/jquery.dataTables.  <%--   
      ...
      /*  document.getElementById("date").textContent = getCurrentDate();*/
        ...
        function DataBind() {
            $.ajax({
                url: 'visithistory.aspx/DataBind2',
                dataType: "json",
                type: 'POST',
                contentType: "application/json",
                success: function (response) {
...
var classs = $("#classs").val(); // Get the selected value
    ...
    $.ajax({
        url: 'visithistory.aspx/Search_DataBind',
