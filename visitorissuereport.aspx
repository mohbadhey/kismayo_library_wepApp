<%@ Page Title="" Language="C#" MasterPageFile="~/homePage.Master" AutoEventWireup="true" CodeBehind="visitorissuereport.aspx.cs" Inherits="library.visitorissuereport" %>
...
<th scope="col"> Days</th>
 ...
 DataBind();
        function DataBind() {
            $.ajax({
                url: 'visitorissuereport.aspx/DataBind2',
                dataType: "json",
                type: 'POST',
...
function Search_id() {
    ...
    $.ajax({
        url: 'visitorissuereport.aspx/Search_id',
        data: "{'search':'" + search + "'}",
        dataType: "json",
        type: 'POST',
        contentType: "application/json",
