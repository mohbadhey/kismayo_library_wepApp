<%@ Page Title="" Language="C#" MasterPageFile="~/homePage.Master" AutoEventWireup="true" CodeBehind="InsertVisit.aspx.cs" Inherits="library.InsertVisit" %>
    ...
    <input type="date"  readonly id="stddate">
        ...
        <script>
                    ...
                    success: function (response) {
                        if (response.d === true) {
                            ...
                            $.ajax({
                                ...
                                data: "{ 'id':'" + id + "' ,  'fname':'" + fname + "','mname':'" + mname + "' ,  'lname':'" + lname + "', 'snumber':'" + snumber + "' , 'gen':'" + gen + "' , 'sem':'" + sem + "' , 'cls':'" + cls + "'} ",
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'json',
                                type: 'POST',
                                success: function (response) {
            ...
            function insertvisit() {
                ...
                $.ajax({
                    url: 'insertStudents.aspx/CheckIdExists1',
                    data: "{ 'id':'" + id + "' } ",
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    type: 'POST',
                    success: function (response) {
                        if (response.d === false) {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Hadda Dhaw Baad soo Boqate',
                                text: 'laguma diwangalinkaro.',
                            });
                        } else {
                            // ID does not exist, proceed with the data insertion
                            $.ajax({
            ...
            $(document).ready(function () {
                var table = $('#datatablee').DataTable({
                    lengthChange: false,
                    language: {
                        searchPlaceholder: 'Search students ...' // Set the placeholder text
                    },
                    buttons: [
                        {
                            extend: 'excel',
